...
function EditableFleet({ currentType, currentCamionId, currentPrestataire, camions, onChange }: { currentType: string, currentCamionId?: string, currentPrestataire?: string, camions: any[], onChange: (updates: any) => void }) {
  ...
  if (isEditing) {
    ...
    return (
      <div className="flex flex-col gap-2 p-3 bg-white dark:bg-slate-900 border border-blue-500/30 rounded-xl shadow-xl z-[100] min-w-[220px]" onClick={e => e.stopPropagation()}>
          ...
          {type === 'interne' ? (
            <>
              ...
              >
                ...
                {camions.filter((c: any) => c.type !== 'externe').map((c: any) => (
